...
class RecommendationScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Get recommendation data from route extra
    final recommendation = GoRouterState.of(context).extra as RecommendationData?;
          ...
          children: [
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Continuing with recommended lenses...'),
            ...
            TextButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('Recommendation saved for later'),
                  ),
                );
              },
              child: Text(
